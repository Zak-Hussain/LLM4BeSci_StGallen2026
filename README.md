...
Please be so kind as to give us feedback on the course (5 min) using this [**survey**](). Thank you!
...
!git clone https://github.com/Zak-Hussain/LLM4BeSci_StGallen2026
```
9. Go back to your Google Drive and navigate to the folder "LLM4BeSci_StGallen2026". You should see the directories `day_1`, `day_2`,`day_3`, `day_4`, and `day_5` containing the relevant notebooks (.ipynb files) and data (it may take  a couple of minutes for the files to appear) for the exercises of each day.
